...
I am a web security researcher at [Palo Alto Networks](https://www.paloaltonetworks.com/network-security) in the San Francisco Bay Area. My work focuses on developing techniques to detect and mitigate online threats like advanced phishing pages and runtime assembly attacks. Previously, I was a researcher at [Huawei Research Canada](https://www.huawei.com/ca/), where I worked on supply chain security using agentic approaches.

I hold a Ph.D. in Computer Engineering from the [University of Toronto](https://www.utoronto.ca/), advised by [Prof David Lie](https://security.csl.toronto.edu/) and [Prof Lianying Zhao](https://people.scs.carleton.ca/~lianyingzhao/). My research explored leveraging machine learning to enhance the security and privacy of web requests. I completed my Master's and Bachelor's degrees at the [University of Toronto](https://www.utoronto.ca/). 